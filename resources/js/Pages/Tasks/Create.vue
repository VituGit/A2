    ...
    <AuthenticatedLayout>
        ...
        <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Criar
                    Tarefa</h2>
                <p class="mt-2 text-lg/8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim
                    voluptate.</p>
            </div>
                    ...
                    <div>
                        ...
                        <form @submit.prevent="handleSubmit">
                            ...
                            <div>
                                ...
                                <textarea v-model="form.description" id="description" class="mt-1 p-2 border"
                                    rows="4"></textarea>
                            </div>
